    ...
    constructor(client) {
        ...
        this.exec = async (message, args, prefix) => {
            ...
            if (args[0].toLowerCase() === `player`) {
                ...
                let b1 = this.client.utils.button(`custom_id`, `Stone Classic`, 2, `Stone_classic_mode`);
                let b2 = this.client.utils.button(`custom_id`, `Stone x Spotify`, 3, `Stone_spotify_mode`);
                let b3 = this.client.utils.button(`custom_id`, `Stone Simple`, 2, `Stone_simple_mode`);
                let b4 = this.client.utils.button(`custom_id`, `Stone Special`, 1, `Stone_special_mode`);
                let b5 = this.client.utils.button(`custom_id`, `No Buttons Style`, 2, `Stone_no_mode`);
                let b6 = this.client.utils.button(`custom_id`, `Stone Old School`, 2, `Stone_old_mode`);
            ...
            if (args[0].toLowerCase() === `dj` ||
                ...
                if (args[1].toLowerCase() === `create`) {
                    ...
                    channel.send(`https://cdn.discordapp.com/attachments/1191733471085858876/1191737831849209968/pngtree-pair-of-headphones-on-the-water-at-nighttime-image_2931863.png?ex=65a68758&is=65941258&hm=82709b29fa0272f20222a0055120ed9a5710cd81b3940e5ffc103dc0094b8f21&`);
