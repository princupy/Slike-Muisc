    ...
    constructor(client) {
        ...
        this.run = async (interaction) => {
            if (interaction.isButton()) {
                ...
                if (interaction.customId === `Stone_classic_mode`) {
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "Stone-classic");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Stone Classic Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                }
                if (interaction.customId === `Stone_spotify_mode`) {
                    if (this.client.utils.checkServerPrem(interaction.guildId) === false &&
                        this.client.utils.checkServerPremStatus(interaction.guildId) ===
                            false)
                        return interaction.update({
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "Stone-spotify");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Stone x Spotify Mode\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                }
                if (interaction.customId === `Stone_simple_mode`) {
                    if (this.client.utils.checkServerPrem(interaction.guildId) === false &&
                        this.client.utils.checkServerPremStatus(interaction.guildId) ===
                            false)
                        return interaction.update({
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "Stone-simple");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Stone Simple Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                }
                if (interaction.customId === `Stone_special_mode`) {
                    if (this.client.utils.checkServerPrem(interaction.guildId) === false &&
                        this.client.utils.checkServerPremStatus(interaction.guildId) ===
                            false)
                        return interaction.update({
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "Stone-special");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Stone Special Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                }
                if (interaction.customId === `Stone_no_mode`) {
                    if (this.client.utils.checkServerPrem(interaction.guildId) === false &&
                        this.client.utils.checkServerPremStatus(interaction.guildId) ===
                            false)
                        return interaction.update({
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "Stone-no");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Stone No Buttons Mode\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                }
                if (interaction.customId === `Stone_old_mode`) {
                    if (this.client.utils.checkServerPrem(interaction.guildId) === false &&
                        this.client.utils.checkServerPremStatus(interaction.guildId) ===
                            false)
                        return interaction.update({
                    ...
                    this.client.utils.updatePlayerMode(interaction.guildId, "Stone-old");
                    return interaction.update({
                        embeds: [
                            this.client.utils
                                .premiumEmbed(interaction.guildId)

                                .setDescription(`${this.client.emoji.tick} Successfully **Updated** the Player to: \`Stone Old School Style\``)
                                .setTimestamp(),
                        ],
                        components: [],
                    });
                }
                if (interaction.customId === `Stone_dj_previous`) {
                ...
                if (interaction.customId === `Stone_dj_stop`) {
                    if (this.client.utils.checkServerPrem(interaction.guild.id) === false &&
                        this.client.utils.checkServerPremStatus(interaction.guild.id) ===
                            false) {
                        this.client.utils.deleteDj(interaction.guild.id);
                ...
                if (interaction.customId === `Stone_dj_pause`) {
                    if (this.client.utils.checkServerPrem(interaction.guild.id) === false &&
                        this.client.utils.checkServerPremStatus(interaction.guild.id) ===
                            false) {
                        this.client.utils.deleteDj(interaction.guild.id);
                ...
                if (interaction.customId === `Whistle_fav`) {
                    if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                        return await interaction.message.delete().catch(() => { });
                    if (interaction.message.id !==
                        this.client.api.get(interaction.guild.id).data.get("Whistle").id)
                        return await interaction.message.delete().catch(() => { });
                    if (!interaction.member.voice.channel &&
                        interaction.guild.members.me.voice.channel)
                        return interaction.reply({
                ...
                if (interaction.customId === `Whistle_volLow`) {
                    if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                        return await interaction.message.delete().catch(() => { });
                    if (interaction.message.id !==
                        this.client.api.get(interaction.guild.id).data.get("Whistle").id)
                ...
                if (interaction.customId === `Whistle_volHigh`) {
                    if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                        return await interaction.message.delete().catch(() => { });
                    if (interaction.message.id !==
                        this.client.api.get(interaction.guild.id).data.get("Whistle").id)
                ...
                if (interaction.customId === `Whistle_shuffle`) {
                    if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                        return await interaction.message.delete().catch(() => { });
                    if (interaction.message.id !==
                        this.client.api.get(interaction.guild.id).data.get("Whistle").id)
                ...
                if (interaction.customId === `Whistle_forward`) {
                    if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                        return await interaction.message.delete().catch(() => { });
                    if (interaction.message.id !==
                        this.client.api.get(interaction.guild.id).data.get("Whistle").id)
                ...
                if (interaction.customId === `Whistle_backward`) {
                    if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                        return await interaction.message.delete().catch(() => { });
                    if (interaction.message.id !==
                        this.client.api.get(interaction.guild.id).data.get("Whistle").id)
            ...
            if (interaction.isSelectMenu()) {
                for (const value of interaction.values) {
                    if (value === `Whistle_reset_filters`) {
                        if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                            return await interaction.message.delete().catch(() => { });
                        if (interaction.message.id !==
                            this.client.api.get(interaction.guild.id).data.get("Whistle").id)
                    ...
                    if (value === `Whistle_filter_bassboost`) {
                        if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                            return await interaction.message.delete().catch(() => { });
                        if (interaction.message.id !==
                            this.client.api.get(interaction.guild.id).data.get("Whistle").id)
                    ...
                    if (value === `Whistle_filter_nightcore`) {
                        if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                            return await interaction.message.delete().catch(() => { });
                        if (interaction.message.id !==
                            this.client.api.get(interaction.guild.id).data.get("Whistle").id)
                    ...
                    if (value === `Whistle_filter_vibrato`) {
                        if (!this.client.api.get(interaction.guildId).data.get(`Whistle`))
                            return await interaction.message.delete().catch(() => { });
                        if (interaction.message.id !==
                            this.client.api.get(interaction.guild.id).data.get("Oras").id)
                    ...
                    if (value === `Whistle_dj_filter_reset`) {
                    ...
                    if (value === `Whistle_dj_filter_bassboost`) {
                        if (this.client.utils.checkServerPrem(interaction.guild.id) ===
                            false &&
                            this.client.utils.checkServerPremStatus(interaction.guild.id) ===
                                false) {
                    ...
                    if (value === `Whistle_dj_filter_nightcore`) {
                        if (this.client.utils.checkServerPrem(interaction.guild.id) ===
                            false &&
                            this.client.utils.checkServerPremStatus(interaction.guild.id) ===
                                false) {
                    ...
                    if (value === `Whistle_dj_filter_vibrato`) {
                        if (this.client.utils.checkServerPrem(interaction.guild.id) ===
                            false &&
                            this.client.utils.checkServerPremStatus(interaction.guild.id) ===
                                false) {
